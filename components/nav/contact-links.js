export default function NavContactLinks({ layout = "site" }) {
  ...
  return (
    <>
      <div className={`${isSidebar ? "col-span-2" : "col-start-18 col-span-2"} flex flex-col`}>
      ...
      <div className={`${isSidebar ? "col-start-3 col-span-5" : "col-start-20 col-span-4"} flex flex-col`}>
